...
function mainInformations() {
  for (i = 0; i < eCommerce.length; i++) {
    console.log(eCommerce[i].title);
    console.log(eCommerce[i].price);
    console.log(eCommerce[i].rating.count);
    console.log("------");
  }
}
let eCommerce = [
...
// 1. seleziona solo title negli oggetti degli array
// 2. fai lo stesso con price e count
// 3. crea 1 ciclo for (o 3) per conteggiare ciascino di questi elementi selezionati
// 4. metti tutto dentro una funzione che come result deve avere 3 console.log, uno per ogni conteggio
